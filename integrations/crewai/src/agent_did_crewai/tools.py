...
def _create_current_identity_runner(context: _ToolRuntimeContext) -> Runner:
    def get_current_identity() -> dict[str, Any]:
        return build_agent_did_identity_snapshot(context.runtime_identity).model_dump(exclude_none=True)

    return get_current_identity


def _create_resolve_did_runner(context: _ToolRuntimeContext) -> Runner:
...
def _create_verify_signature_runner(context: _ToolRuntimeContext) -> Runner:
...
def _create_sign_payload_runner(context: _ToolRuntimeContext) -> Runner:
...
def _create_sign_http_request_runner(context: _ToolRuntimeContext) -> Runner:
...
def _create_document_history_runner(context: _ToolRuntimeContext) -> Runner:
...
def _create_rotate_key_runner(context: _ToolRuntimeContext) -> Runner:
    ...
    *,
    ...
    tool_specs = [
        _build_tool(
            ...
            runner=_create_current_identity_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_resolve_did_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_verify_signature_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_sign_payload_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_sign_http_request_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_document_history_runner(context),
        ),
        _build_tool(
            ...
            runner=_create_rotate_key_runner(context),
        ),
    ]
