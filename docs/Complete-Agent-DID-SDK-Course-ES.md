...
| 4 | "¿Funciona con LangChain/CrewAI?" | Sí. La integración con LangChain ya está implementada en [../integrations/langchain/README.md](../integrations/langchain/README.md) y CrewAI ya tiene una integración Python funcional en [../integrations/crewai/README.md](../integrations/crewai/README.md). Microsoft Agent Framework (Semantic Kernel) sigue en F2-04 como adapter Python en construcción con scaffold gobernado. El SDK sigue siendo framework-agnostic — cualquier host puede reutilizar la capa de identidad aunque la ergonomía por framework evolucione por separado. |
